...
class SpriteAnimator:
    ...
    def create_avatar_widget(self, width: int = 200, height: int = 200) -> QLabel:
        ...
        initial_pixmap = self.idle_frames[0].scaled(width, height, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def _animate(self, widget: QLabel):
        ...
        scaled_pixmap = frames[self.current_frame].scaled(widget.width(), widget.height(), Qt.KeepAspectRatio, Qt.SmoothTransformation)
